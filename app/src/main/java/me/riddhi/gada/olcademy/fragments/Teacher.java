...
import me.riddhi.gada.olcademy.MyCourses;
...
public class Teacher extends Fragment {
    ...
    Dialog myDialog;
    TextView settings, signout, txtclose, createCourse,out, myCourses;
    Button btnCreate;
    EditText courseName;
    ImageView userImg;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        myCourses = (TextView) view.findViewById(R.id.txtMyCourses);
